...
#define scale1Calibration 4990.666 //Front Right scale WA change this number based on what you get from running the calibration sketch. need to do this for each scale.

#define scale2RX  7
#define scale2TX  6
#define scale2Calibration 5092.8 //Front Left scale

#define scale3RX  9
#define scale3TX  8
#define scale3Calibration 5240.633 //Back Left scale

#define scale4RX  3
#define scale4TX  2
#define scale4Calibration 5068.266 //Back Right scale
